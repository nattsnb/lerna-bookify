...
export declare class VenueService {
    ...
    create(createVenueData: CreateVenueDto, userId: number): Promise<{
        rating: number;
        description: string;
        name: string;
        id: number;
    ...
    update(venueId: number, updateVenueData: UpdateVenueDto): Promise<{
        rating: number;
        description: string;
        name: string;
        id: number;
    ...
    filterCombined(amenityIds: number[], occasionIds: number[]): Promise<({
        reservations: {
            id: number;
            venueId: number;
            userId: number;
