...
let VenueController = class VenueController {
    ...
    filterByAmenitiesAndOccasions(filterDto) {
        return this.venueService.filterCombined(filterDto.amenities ?? [], filterDto.occasions ?? []);
    }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], VenueController.prototype, "filterByAmenitiesAndOccasions", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], VenueController.prototype, "getOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], VenueController.prototype, "headRoute", null);
