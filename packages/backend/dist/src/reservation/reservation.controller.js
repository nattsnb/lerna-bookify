...
let ReservationController = class ReservationController {
    ...
    checkAvailability(venueId, from, to) {
        ...
        return this.reservationService.checkAvailability(venueId, dateStart, dateEnd);
    }
    getOccupiedDates(id) {
    ...
    create(createReservationData, request) {
        return this.reservationService.create(createReservationData, request.user.id);
    }
    delete(id) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReservationController.prototype, "getOccupiedDates", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], ReservationController.prototype, "getByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], ReservationController.prototype, "getByVenue", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
