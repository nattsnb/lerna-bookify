...
var CategoryController = (function () {
  ...
  var CategoryController = (_classThis = /** @class */ (function () {
    function CategoryController_1(occasionService) {
      this.occasionService =
        (__runInitializers(this, _instanceExtraInitializers), occasionService);
    }
    CategoryController_1.prototype.getAll = function () {
      return this.occasionService.getAll();
    };
    CategoryController_1.prototype.create = function (createOccasionData) {
      return this.occasionService.create(createOccasionData);
    };
    CategoryController_1.prototype.getOne = function (id) {
      return this.occasionService.getOne(id);
    };
    CategoryController_1.prototype.update = function (id, updateOccasionData) {
