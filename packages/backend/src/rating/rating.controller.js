...
var RatingController = (function () {
  var _classDecorators = [(0, common_1.Controller)('rating')];
  ...
  var RatingController = (_classThis = /** @class */ (function () {
    function RatingController_1(ratingService) {
      this.ratingService =
        (__runInitializers(this, _instanceExtraInitializers), ratingService);
    }
    RatingController_1.prototype.getAll = function () {
      return this.ratingService.getAll();
    };
    RatingController_1.prototype.getByUser = function (id) {
      return this.ratingService.getByUser(id);
    };
    RatingController_1.prototype.getByVenue = function (id) {
      return this.ratingService.getByVenue(id);
    };
    RatingController_1.prototype.getOne = function (id) {
      return this.ratingService.getOne(id);
    };
    RatingController_1.prototype.create = function (createRatingData) {
      return this.ratingService.create(createRatingData);
    };
    RatingController_1.prototype.delete = function (id) {
      return this.ratingService.delete(id);
    };
    return RatingController_1;
  })());
