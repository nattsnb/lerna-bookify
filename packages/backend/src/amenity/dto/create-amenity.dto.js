...
var CreateAmenityDto = (function () {
  ...
  return (
    (_a = /** @class */ (function () {
      function CreateAmenityDto() {
        this.name = __runInitializers(this, _name_initializers, void 0);
        this.categoryId =
          (__runInitializers(this, _name_extraInitializers),
          __runInitializers(this, _categoryId_initializers, void 0));
    ...
    (function () {
      ...
      __esDecorate(
        ...
        _categoryId_initializers,
        _categoryId_extraInitializers,
      );
      if (_metadata)
