...
var log_in_dto_1 = require('./dto/log-in.dto');
var jwt_authentication_guard_1 = require('./jwt-authentication.guard');
var authentication_response_dto_1 = require('./dto/authentication-response.dto');
...
var AuthenticationController = (function () {
  ...
  var AuthenticationController = (_classThis = /** @class */ (function () {
    function AuthenticationController_1(authenticationService) {
      this.authenticationService =
        (__runInitializers(this, _instanceExtraInitializers),
        authenticationService);
    }
    AuthenticationController_1.prototype.signUp = function (signUpData) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [2 /*return*/, this.authenticationService.signUp(signUpData)];
        });
      });
    };
    AuthenticationController_1.prototype.logIn = function (
      logInData,
      response,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.authenticationService.logIn(logInData, response),
          ];
        });
      });
    };
    ...
    AuthenticationController_1.prototype.authenticate = function (request) {
  ...
  (function () {
    ...
    _signUp_decorators = [
      ...
      (0, class_transformer_1.TransformPlainToInstance)(
        authentication_response_dto_1.AuthenticationResponseDto,
      ),
    ];
    _logIn_decorators = [
